...
const detalheSchema = {
  ...
  properties: {
    ...
    comoUsarAcademico:      { type: 'string' },
    comoUsarProfissional:    { type: 'string' },
    comoUsarCotidiano:       { type: 'string' },
    comoOportunidade:     { type: 'array', items: { type: 'string' } },
    exemplosOportunidadeAcademico:      { type: 'string' },
    exemplosOportunidadeProfissional:    { type: 'string' },
    exemplosOportunidadeFamiliar:          { type: 'string' },
    exemplosOportunidadeAmigosColegas:     { type: 'string' },
    exemplosOportunidadeParceiros:         { type: 'string' },
    exemplosPraticosEstudo:    { type: 'string' },
    exemplosPraticosTrabalho:  { type: 'string' },
    exemplosPraticosCotidiano: { type: 'string' },
    fraquezaOuAmeaca:     { type: 'array', items: { type: 'string' } },
    ...
    transformarEmForca:          { type: 'array', items: { type: 'string' } },
    transformarEmOportunidade:   { type: 'array', items: { type: 'string' } },
